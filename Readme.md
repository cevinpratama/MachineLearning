...
* **Panduan Praktis:** Memberikan panduan langkah demi langkah, terutama dalam proses penting seperti Exploratory Data Analysis (EDA).
...
➡️ **[Klik di sini untuk melihat Contoh Slide Presentasi EDA (Google Drive)](https://drive.google.com/drive/folders/1TIjIqp55MSWkVHk4eDPjY7PEYmb-a29c?usp=sharing)**
...
* `requirements.txt:` Daftar library Python yang diperlukan untuk menjalankan kode.
...
2.  Buat **Branch** baru untuk fitur atau perbaikan Anda (`git checkout -b fitur/nama-fitur-baru`).
...
Mari kita bangun sumber belajar ini bersama-sama!
